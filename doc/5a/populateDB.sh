...
psql project1 -c "\COPY Energy_type(Name, Environmental_unit_cost, Units)
FROM '/home/lion/cab-project-01-6/doc/5a/csv/Energy_Type.csv'
DELIMITER ','
CSV HEADER;
"
...
psql project1 -c "\COPY Month_Temp(Name, Num_days)
FROM '/home/lion/cab-project-01-6/doc/5a/csv/Month.csv'
DELIMITER ','
CSV HEADER;"
...
psql project1 -c "\COPY Meter(Name, Energy_type, Units)
FROM '/home/lion/cab-project-01-6/doc/5a/csv/Meter.csv'
DELIMITER ','
CSV HEADER;"
...
psql project1 -c "CREATE TABLE Temp_meter_month_cost (
        Month_name DATE,
...
SELECT month_name, meter_name, SUM(amount), SUM(total_monetary_cost), SUM(total_environmental_cost)
